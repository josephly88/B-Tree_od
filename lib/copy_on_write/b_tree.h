...
class BTree{
	...
	public:
		...
		void node_read(int block_id, BTreeNode<T>* node);
		void node_write(int block_id, BTreeNode<T>* node);
...
template <typename T>
void BTree<T>::node_read(int block_id, BTreeNode<T>* node){
    if(block_id == 0){
...
template <typename T>
void BTree<T>::node_write(int block_id, BTreeNode<T>* node){
    if(block_id == 0){
